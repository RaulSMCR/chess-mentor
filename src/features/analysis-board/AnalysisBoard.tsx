...
export function AnalysisBoard({ repository }: AnalysisBoardProps) {
  ...
  const [activeView, setActiveView] = useState<"game" | "trainer">("game");
  ...
  return (
    <main className="analysis-shell">
      ...
      <nav className="workspace-tabs" aria-label="Vistas principales">
        <button
          type="button"
          role="tab"
        ...
        <button
          type="button"
          role="tab"
          aria-selected={activeView === "trainer"}
      ...
      {activeView === "game" ? (
        <>
          ...
          <GameToolbar
            busy={
              controller.state.busy || controller.state.status === "loading"
            }
